    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resetTime', models.CharField(blank=True, max_length=20, null=True, verbose_name='Reset时长')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_num', models.CharField(blank=True, max_length=10, null=True, verbose_name='工号')),
                ...
                ('account_type', models.SmallIntegerField(choices=[(0, '發佈者'), (1, '接收者')], default=0, verbose_name='账号类别')),
